...
public class MovieImporterService {
    ...
    public UUID importMovie(String movieExternalId, String languageIsoCode)
        ...
        List<MovieCreditsCastReadDTO> creditsCastReadDTOS = movieCredits.getCast();
        creditsCastReadDTOS.stream().map(castPerson -> importCast(castPerson, internalMovie))
                .collect(Collectors.toList());

        List<MovieCreditsCrewReadDTO> movieCreditsCrewReadDTOS = movieCredits.getCrew();
        movieCreditsCrewReadDTOS.stream().map(crewPerson -> importCrew(crewPerson, internalMovie))
                .collect(Collectors.toList());
    ...
    private MovieCreditsCastReadDTO importCast(MovieCreditsCastReadDTO castPerson, Movie internalMovie) {
    ...
    private MovieCreditsCrewReadDTO importCrew(MovieCreditsCrewReadDTO crewPerson, Movie internalMovie) {
        ...
        if (internalCrewType == null) {
            ...
            internalCrewType = crewTypeRepository.save(crewType);
