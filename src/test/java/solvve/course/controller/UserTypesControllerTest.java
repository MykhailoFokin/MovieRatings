...
public class UserTypesControllerTest {
    ...
    private UserTypesReadDTO createUserTypesRead() {
    ...
    public void testGetUserTypes() throws Exception {
        UserTypesReadDTO userTypes = createUserTypesRead();
    ...
    public void testCreateUserTypes() throws Exception {
        ...
        UserTypesReadDTO read = createUserTypesRead();
    ...
    public void testPatchUserTypes() throws Exception {
        ...
        UserTypesPatchDTO patchDTO = new UserTypesPatchDTO();
        patchDTO.setUserGroup(UserGroupType.USER);

        UserTypesReadDTO read =createUserTypesRead();

        Mockito.when(userTypesService.patchUserTypes(read.getId(),patchDTO)).thenReturn(read);
    ...
    public void testDeleteUserTypes() throws Exception {
        ...
        Mockito.verify(userTypesService).deleteUserTypes(id);
    }
}
