...
public class NewsUserTypoRequestControllerTest extends BaseControllerTest {
    ...
    public void testGetUserTypoRequest() throws Exception {
        ...
        Mockito.when(userTypoRequestService.getUserTypoRequestsByNewsAndRequester(userTypoRequest.getNewsId(),
        ...
        Mockito.verify(userTypoRequestService).getUserTypoRequestsByNewsAndRequester(userTypoRequest.getNewsId(),
                userTypoRequest.getRequesterId());
    }
    ...
    public void testGetUserTypoRequestWrongId() throws Exception {
        ...
        Mockito.when(userTypoRequestService.getUserTypoRequestsByNewsAndRequester(wrongId, wrongId))
                .thenThrow(exception);
    ...
    public void testCreateUserTypoRequest() throws Exception {
        ...
        Mockito.when(userTypoRequestService.
                createUserTypoRequest(create.getNewsId(), create)).thenReturn(read);

        String resultJson = mvc.perform(post("/api/v1/news/{newsId}/user-typo-requests",
                create.getNewsId())
