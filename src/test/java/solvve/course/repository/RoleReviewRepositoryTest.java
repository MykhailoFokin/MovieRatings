...
@SpringBootTest
@Sql(statements = "delete from role_review; delete from role; delete from persons; delete from portal_user; delete from user_types;", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
@ActiveProfiles("test")
